...
void main() {
	...
	`}class Vo extends jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new No(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}const Ld={[fo]:"Linear",[po]:"Reinhard",[mo]:"Cineon",[go]:"ACESFilmic",[xo]:"AgX",[vo]:"Neutral",[_o]:"Custom"};function Id(i,e){const t=Ld[e];return t===void 0?(we("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ir=new O;function Ud(){Ve.getLuminanceCoefficients(ir);const i=ir.x.toFixed(4),e=ir.y.toFixed(4),t=ir.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const kd={[rr]:"SHADOWMAP_TYPE_PCF",[Ei]:"SHADOWMAP_TYPE_VSM"};function Wd(i){return kd[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Xd={[Gn]:"ENVMAP_TYPE_CUBE",[oi]:"ENVMAP_TYPE_CUBE",[dr]:"ENVMAP_TYPE_CUBE_UV"};function qd(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Xd[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Yd={[oi]:"ENVMAP_MODE_REFRACTION"};function Zd(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Yd[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Kd={[ho]:"ENVMAP_BLENDING_MULTIPLY",[Sl]:"ENVMAP_BLENDING_MIX",[El]:"ENVMAP_BLENDING_ADD"};function jd(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Kd[i.combine]||"ENVMAP_BLENDING_NONE"}function $d(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Jd(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Wd(t),l=qd(t),h=Zd(t),d=jd(t),u=$d(t),m=Fd(t),_=Nd(s),M=r.createProgram();let p,f,S=t.glslVersion?"#version "+t.glslVersion+`
